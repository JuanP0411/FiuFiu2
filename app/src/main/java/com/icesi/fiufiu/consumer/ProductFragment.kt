...
import com.icesi.fiufiu.databinding.FragmentProductBinding
import com.icesi.fiufiu.model.*
import com.icesi.fiufiu.util.Constants
...
class ProductFragment : Fragment() {
    ...
    private fun buildOrder(): Order{
        ...
        return Order(amount,name,price, totalPrice, product.imageID, currentService.id,
